...
public class Lighting_Bar_Chart_Report extends ApplicationFrame {
    ...
    List<Lighting_Data> lData;

    public Lighting_Bar_Chart_Report(boolean show, String title) {
        super(title);
    ...
    private void selectAll() {
        try {
            lData = sql.select_lighting_expense();
        }
        catch(Exception e) {
            e.printStackTrace();
        }
    }
    private void getLiExpenses() {
        ListIterator<Lighting_Data> data_list = lData.listIterator();
