...
public class Fertilizer_PDF_Report {
    SQL_Handler sql = new SQL_Handler();

    String end = getDate() + " " + getTime();
    private String FILE = "Reports/Basic Reports/Fertilizer Reports/" + end + ".pdf";
    ...
    private void addMetaData(Document document) {
    	document.addTitle("Fertilizer Overview Report");
	document.addSubject("Fertilizer");
	document.addKeywords("Basics, Fertilizer, Report");
	...
	Fertilizer_Pie_Chart_Report chart = new Fertilizer_Pie_Chart_Report(show, "Comparison", "Fertilizer Expenses Overview");
        Image To_be_Added = null;
	try {
