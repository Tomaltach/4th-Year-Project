...
public class Gas_PDF_Report {
    SQL_Handler sql = new SQL_Handler();

    String end = getDate() + " " + getTime();
    private String FILE = "Reports/Basic Reports/Gas Reports/" + end + ".pdf";
    ...
    private void addMetaData(Document document) {
    	document.addTitle("Gas Overview Report");
	document.addSubject("Gas");
	document.addKeywords("Basics, Gas, Report");
