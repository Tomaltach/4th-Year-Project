...
public class Lighting_PDF_Report {
    SQL_Handler sql = new SQL_Handler();

    String end = getDate() + " " + getTime();
    private String FILE = "Reports/Basic Reports/Lighting Reports/" + end + ".pdf";
    ...
    private void addMetaData(Document document) {
    	document.addTitle("Lighting Overview Report");
	document.addSubject("Lighting");
	document.addKeywords("Basics, Lighting, Report");
	...
	Lighting_Bar_Chart_Report chart = new Lighting_Bar_Chart_Report(show, "Lighting Expenses Overview");
	...
	Lighting_Pie_Chart_Report chart = new Lighting_Pie_Chart_Report(show, "Comparison", "Lighting Expenses Overview");
        Image To_be_Added = null;
	try {
