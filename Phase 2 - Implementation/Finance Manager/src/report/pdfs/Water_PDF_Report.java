...
public class Water_PDF_Report {
    SQL_Handler sql = new SQL_Handler();

    String end = getDate() + " " + getTime();
    private String FILE = "Reports/Basic Reports/Water Reports/" + end + ".pdf";
	...
	preface.add(new Paragraph("Water Overview", catFont));
