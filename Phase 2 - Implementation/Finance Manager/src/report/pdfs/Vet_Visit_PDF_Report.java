...
public class Vet_Visit_PDF_Report {
    SQL_Beef_Handler sql = new SQL_Beef_Handler();

    String end = getDate() + " " + getTime();
    private String FILE = "Reports/Beef Reports/Vet Visit Reports/" + end + ".pdf";
	...
	preface.add(new Paragraph("Vet Visit Overview", catFont));
	...
	Vet_Visit_Bar_Chart_Report chart = new Vet_Visit_Bar_Chart_Report(show, "Vet Visit Expenses Overview");
	...
	Vet_Visit_Pie_Chart_Report chart = new Vet_Visit_Pie_Chart_Report(show, "Comparison", "Vet Visit Expenses Overview");
        Image To_be_Added = null;
	try {
