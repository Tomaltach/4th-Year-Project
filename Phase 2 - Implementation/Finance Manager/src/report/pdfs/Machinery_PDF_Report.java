...
public class Machinery_PDF_Report {
    SQL_Handler sql = new SQL_Handler();

    String end = getDate() + " " + getTime();
    private String FILE = "Reports/Basic Reports/Machinery Reports/" + end + ".pdf";
    ...
    private void addMetaData(Document document) {
    	document.addTitle("Machinery Overview Report");
	document.addSubject("Machinery");
	document.addKeywords("Basics, Machinery, Report");
	...
	Machinery_Bar_Chart_Report chart = new Machinery_Bar_Chart_Report(show, "Machinery Expenses Overview");
	...
	Machinery_Pie_Chart_Report chart = new Machinery_Pie_Chart_Report(show, "Comparison", "Machinery Expenses Overview");
        Image To_be_Added = null;
	try {
