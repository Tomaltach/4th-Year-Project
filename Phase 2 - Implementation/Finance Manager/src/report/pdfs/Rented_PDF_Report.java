...
public class Rented_PDF_Report {
    SQL_Handler sql = new SQL_Handler();

    String end = getDate() + " " + getTime();
    private String FILE = "Reports/Basic Reports/Rented Reports/" + end + ".pdf";
	...
	preface.add(new Paragraph("Rented Overview", catFont));
	...
	Rented_Bar_Chart_Report chart = new Rented_Bar_Chart_Report(show, "Rented Expenses Overview");
	...
	Rented_Pie_Chart_Report chart = new Rented_Pie_Chart_Report(show, "Comparison", "Rented Expenses Overview");
        Image To_be_Added = null;
	try {
